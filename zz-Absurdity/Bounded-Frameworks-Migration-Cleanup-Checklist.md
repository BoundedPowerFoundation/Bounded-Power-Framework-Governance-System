...
Source: review of `Bounded-Power-Framework-main`, the new-domain zips, the cross-AI
registration attempts (0020 Perplexity, 0021 Gemini), and harvest pass on the five
external assessments in `05-Reference/`.
...
├── README.md                          ← multi-domain orientation; introduces "The
